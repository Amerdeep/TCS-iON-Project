...
if app_mode == 'Home':
    ...
    image=Image.open(r"C:\Users\illca\Downloads\331966807_589469919711983_637032812803627793_n.jpg")
    st.image(image,caption='HR Prediction Model For Predicting The Salaries Of Different People.')
    ...
    if sex == 'Female':
        ...
        sex = 0
    age = st.number_input('Enter Your Age Between 17 to 90',min_value=0,max_value=90,step=1)
    ...
    if st.button('Get Your Prediction'):
        ...
        if result == 0:
            st.success('The Salary 💰 Will Be Below Or Equal to 50K$ 👏👏')
        else:
